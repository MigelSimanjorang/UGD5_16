...
class TambahPesananActivityTest {

    @Rule
    @JvmField
    var mActivityScenarioRule = ActivityScenarioRule(TambahPesananActivity::class.java)

    @Test
    fun tambahPesananActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Adidas Black Fast"), closeSoftKeyboard())
